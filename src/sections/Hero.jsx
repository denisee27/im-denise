  ...
  return (
    <section ref={sectionRef} className="min-h-screen flex flex-col justify-center px-6 md:px-12 max-w-7xl mx-auto relative pt-20">
      <div className="max-w-4xl">
        <h1 className="font-serif text-5xl md:text-8xl leading-[1.1] tracking-tight mb-9">
          <div className="overflow-hidden"><div className="hero-title-line">Full-Stack</div></div>
          <div className="overflow-hidden pb-2"><div className="hero-title-line text-neutral-400">Application Engineer</div></div>
        </h1>
        <p className=" hero-desc text-lg md:text-xl text-neutral-600 max-w-2xl leading-relaxed font-light">
